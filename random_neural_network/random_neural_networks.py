...
class RandomNNClassifier(BaseRandomNN, ClassifierMixin):
    ...
    def __init__(self, n_hidden=100, activation='relu', C=1,
                 class_weight="balanced", weight_scale=1.0, batch_size=None,
                 verbose=False, warm_start=False, random_state=None):
        super(RandomNNClassifier, self).__init__(n_hidden=n_hidden,
    ...
    def partial_fit(self, X, y, classes=None, sample_weight=None):
        ...
        super(RandomNNClassifier, self).partial_fit(X, y, sample_weight)

        return self

    def decision_function(self, X):
        """Decision function of the RandomNN model
...
class RandomNNRegressor(BaseRandomNN, RegressorMixin):
    """Extreme learning machine regressor.

    The algorithm trains a single-hidden layer feedforward network by computing
    the hidden layer values using randomized parameters, then solving
    for the output weights using least-square solutions. For prediction,
    RandomNNRegressor computes the forward pass resulting in continuous output
    values.
    ...
    def __init__(self, n_hidden=100, activation='relu', weight_scale=1.0,
                 ...
                 random_state=None):
        super(RandomNNRegressor, self).__init__(n_hidden=n_hidden,
                                           activation=activation,
